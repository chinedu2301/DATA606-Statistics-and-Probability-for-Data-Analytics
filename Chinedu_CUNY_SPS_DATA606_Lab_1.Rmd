...
**Yes there is a trend in the number of girls baptized over the years. There was an increase in the number of girls baptized until 1640 and then decrease until 1660 followed by another increase. Generally, the number of girls baptized increased from 1660.**
...
```{r exercise-4-solution-years}
summary(present) 
```

**The years included in this data set are: 1940 to 2002**    
The dimensions of the dataframe is given by:  

```{r exercise-4-solution-dimensions}
dim(present)
```
...
colnames(present)
```
**The column names(variables) are: "year", "boys", and "girls"** 
...
**The dimension of counts for 'present' is 63 x 3 while that or 'arbuthnot' is 82 x 3. Also, counts in arbuthnot is in the "thousands" while that of 'present' is in the "millions". Hence, they are of different scale and magnitude**  
...
```{r exercise-6-solution-prop-of-boys-girls}
